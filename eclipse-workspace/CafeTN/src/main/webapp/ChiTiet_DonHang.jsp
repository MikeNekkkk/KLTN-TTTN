	...
	<div class="discover_menu_inner">
		<div class="container">
			<div class="main_title">
				...
				<h5>
					Đơn hàng #${order.id} đã được đặt vào lúc <span
						style="color: rgb(254, 209, 56); font-weight: bold;"><fmt:formatDate
							value="${order.createdAt}" pattern="HH:mm 'ngày' dd/MM/yyyy" /></span>
				</h5>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<div class="discover_item_inner">
						<div class="discover_item">
							...
							<c:forEach var="item" items="${DTorders}">
								...
								<p>
									${item.productName} x${item.quantity}<span><fmt:formatNumber value=" ${item.subtotal}" pattern="#,##0"/>₫
									</span>
								</p>
							</c:forEach>
						</div>
