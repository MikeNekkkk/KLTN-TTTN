				...
				<div class="row footer_wd_inner">
					<div class="col-lg-3 col-6">
						<aside class="f_widget f_about_widget">
							<img style="width: 100%; height: 100%;" ; src="img/fav-icon.png"
								alt="">
								<ul class="nav">
								...
								<li><a
									href="https://twitter.com/share?url=https://trungnguyenlegendcafe.net/ca-phe-dua-nang-luong-thanh-mat-tu-san-vat-nhiet-doi-2/"><i
					...
					<div class="col-lg-3 col-6">
						<aside class="f_widget f_contact_widget">
							...
							<h4>CÔNG TY CỔ PHẦN TRUNG NGUYÊN FRANCHISING</h4>
							<!-- 							<h4>Hotline Miền Nam: 0915 493 322</h4>
 -->
							<p>
								Hotline Miền Nam: 0915 493 322 <br>Hotline Miền Nam: 0915
								493 322 <br />87A Cách Mạng Tháng 8, Phường Bến Thành, Quận 1,
								Hồ Chí Minh


							</p>
							<h5>trungnguyenfranchising@trungnguyenlegend.com</h5>
						</aside>
					</div>
				</div>
			</div>
